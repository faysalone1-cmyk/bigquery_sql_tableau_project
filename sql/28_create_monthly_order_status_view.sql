-- Phase 5: deploy monthly order-status reporting.
-- Current status by order creation month; not historical status at month-end.
-- Processing/Shipped counts are recorded statuses, not a verified backlog.
CREATE OR REPLACE VIEW
  `bigquery-analyst-practice.thelook_practice.monthly_order_status` AS
