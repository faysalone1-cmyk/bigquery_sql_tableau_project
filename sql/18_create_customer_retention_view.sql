-- Create the permanent customer-retention cohort reporting view.
-- Grain: one row per first-purchase cohort month and elapsed month (0-12).
-- Recent cohorts stop at the latest completed calendar month.

CREATE OR REPLACE VIEW
  `bigquery-analyst-practice.thelook_practice.customer_retention_cohorts` AS
